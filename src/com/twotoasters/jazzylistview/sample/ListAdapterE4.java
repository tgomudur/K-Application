...
class ListAdapterE4 extends ArrayAdapter<String> {
	...
	int imagelist[] = { R.drawable.scitechimg2, R.drawable.biz1,
			R.drawable.howstuffworks1, R.drawable.schoolquiz1,
			R.drawable.openquiz1 };

	public ListAdapterE4(Context context, int itemLayout) {

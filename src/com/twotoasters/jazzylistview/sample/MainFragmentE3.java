...
public class MainFragmentE3 extends FragmentActivity {
	...
	public class MyPagerAdapter3 extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "K! Entrepreneur", "Chaos Theory",
				"K! Idol" };
		...
		public Fragment getItem(int position) {
			...
			return SuperAwesomeEvent3.newInstance(position);
		}

...
public class MainFragmentE5 extends FragmentActivity {
	...
	public class MyPagerAdapter3 extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "Angry Bots", "Robo Wars", "Crisis",
				"Designer's Quest", "Pac Bots" };
		...
		public Fragment getItem(int position) {
			...
			return SuperAwesomeEvent5.newInstance(position);
		}

...
class ListAdapter1 extends ArrayAdapter<String> {
	...
	int imagelist[] = { R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1, R.drawable.robowars1, R.drawable.godspeed1,
			R.drawable.godspeed1 };

	public ListAdapter1(Context context, int itemLayout) {
		super(context, itemLayout, R.id.text, ListModel1.getModel());

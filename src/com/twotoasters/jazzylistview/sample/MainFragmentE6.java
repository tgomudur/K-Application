...
public class MainFragmentE6 extends FragmentActivity {
	...
	public class MyPagerAdapter3 extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "BIZQUIZ Bangalore", "Robo Soccer",
				"Game Development", "BIZQUIZ Mumbai",
		...
		public Fragment getItem(int position) {
			...
			return SuperAwesomeEvent6.newInstance(position);
		}

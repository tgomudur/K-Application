...
class ListAdapterKarnival extends ArrayAdapter<String> {
	...
	int imagelist[] = { R.drawable.ace, R.drawable.ars, R.drawable.helpline,
			R.drawable.inceg, R.drawable.nomad, R.drawable.sewebot,
			R.drawable.baker1, R.drawable.livecoding1, R.drawable.texas1,
			R.drawable.nugen1, R.drawable.mobileapp1 };

	// int workshop_photos[]={R.drawable.k};

	public ListAdapterKarnival(Context context, int itemLayout) {
		super(context, itemLayout, R.id.text, ListModelKarnival.getModel());

...
public class MainFragmentE4 extends FragmentActivity {
	...
	public class MyPagerAdapter3 extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "SCI TECH QUIZ", "Biz Quiz",
				"How Stuff Works", "School Quiz", "Open Quiz" };
		...
		public Fragment getItem(int position) {
			...
			return SuperAwesomeEvent4.newInstance(position);
		}

...
public class GetDirectionsAsyncTaskNew extends
	...
	private MapNavigation activity;
	private Exception exception;
	private ProgressDialog progressDialog;

	public GetDirectionsAsyncTaskNew(MapNavigation mapNavigation) {
		// TODO Auto-generated constructor stub
		super();
		this.activity = mapNavigation;
	}
	...
	protected ArrayList<LatLng> doInBackground(Map<String, String>... params) {
		...
		try {
			...
			GMapV2DirectionNew md = new GMapV2DirectionNew();
	...
	private void processException() {
		Toast.makeText(activity, "Internet Connection Error", 3000).show();
	}
}
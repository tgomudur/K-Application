...
public class MainFragmentE7 extends FragmentActivity {
	...
	public class MyPagerAdapter3 extends FragmentPagerAdapter {
		...
		private final String[] TITLES = { "Riddles of the Sphinx", "Cerebra",
		...
		public Fragment getItem(int position) {
			...
			return SuperAwesomeEvent7.newInstance(position);
		}

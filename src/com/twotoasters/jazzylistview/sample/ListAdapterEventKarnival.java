...
class ListAdapterEventKarnival extends ArrayAdapter<String> {
	...
	int imagelist[] = { R.drawable.magicshow, R.drawable.paintingthreed,
	...
	public ListAdapterEventKarnival(Context context, int itemLayout) {
